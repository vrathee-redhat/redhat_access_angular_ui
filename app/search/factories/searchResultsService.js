...
export default ($q, $rootScope, AUTH_EVENTS, SEARCH_PARAMS, AlertService, securityService, strataService, translate) => {
    'ngInject';

    const searchArticlesOrSolutions = function (searchString, limit) {
        //var that = this;
    ...
    const searchProblems = function (data, limit) {
        if (limit === undefined || limit < 1) {
            limit = SEARCH_PARAMS.limit;
        }
        service.clear();
