...
export default class EditGroup {
    constructor($scope, strataService, CaseService, AlertService, $filter, ngTableParams, GroupUserService, SearchBoxService, $location, securityService, RHAUtils, AUTH_EVENTS, gettextCatalog, CASE_EVENTS) {
        'ngInject';
