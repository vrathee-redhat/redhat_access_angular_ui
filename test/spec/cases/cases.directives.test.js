...
describe('Case Directives', function() {
    ...
    beforeEach(function() {
        inject(function($injector,_MockStrataDataService_,_RecommendationsService_,_AttachmentsService_,
            _CaseService_) {
    ...
    describe('commentsSection', function() {
        ...
        it('should display the comments section when comments present', function() {
            ...
            expect(element.find('.rha-comment-text').text()).toEqual(mockStrataDataService.mockComments[0].text);
